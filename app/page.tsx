...
const sampleCrops = [
  {
    ...
    name: "Rice",
    howToGrow:
      "Requires flooded fields and warm climate. Plant in spring for best results.",
  ...
  },
  {
    ...
    name: "Wheat",
    howToGrow:
      "Grows well in well-drained soil with moderate temperature. Winter wheat is recommended.",
  ...
  },
  {
    ...
    name: "Corn",
    howToGrow:
      "Plant in spring when soil warms. Needs full sun and regular watering.",
...
const testimonials = [
  {
    id: "1",
    quote:
      "CropPredict helped me increase my yield by 30% by suggesting the right crops for my soil conditions.",
    author: "Rajesh Kumar",
  ...
  },
  {
    id: "2",
    quote:
      "I was skeptical at first, but the recommendations were spot on. My farm has never been more productive.",
    author: "Anita Desai",
  ...
  },
  {
    id: "3",
    quote:
      "The weather predictions combined with crop suggestions have helped me plan better and reduce losses.",
    author: "Sanjay Patel",
...
const communityPosts = [
  {
    ...
    region: "Karnataka",
    content:
      "Just harvested my first crop of organic tomatoes using the techniques suggested here. The yield was amazing!",
  ...
  },
  {
    ...
    region: "Kerala",
    content:
      "The monsoon prediction was accurate. Prepared my fields early as suggested and saved my entire crop from flooding.",
...
const blogData = [
  {
    ...
    excerpt:
      "Learn how technology is transforming traditional farming practices...",
    author: "Dr. Singh",
    date: "April 10, 2023",
    readTime: "5 min read",
    category: "Technology",
        ...
        {imageUrl && (
          <img
            ...
            onError={() =>
              setImageUrl(
                getPlaceholderImage(
                  `crop-${name.toLowerCase().replace(/\s+/g, "-")}-error`
                )
              )
            }
          />
...
const Testimonial = ({
  ...
  useEffect(() => {
    ...
    setImageUrl(
      getPlaceholderImage(
        `farmer-${location.split(",")[0].toLowerCase()}-${location
          .split(",")[1]
          .toLowerCase()}`
      )
    );
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-xl p-8 shadow-md hover:shadow-lg transition-all duration-300 border border-gray-100 dark:border-gray-700 h-full flex flex-col">
      <div className="mb-6">
        <svg
          className="h-8 w-8 text-green-500 dark:text-green-400 mb-2"
          fill="currentColor"
          viewBox="0 0 32 32"
    ...
    <div className="bg-white dark:bg-gray-800 rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-all duration-300 border border-gray-100 dark:border-gray-700">
          ...
          {imageUrl ? (
            <>
              <img
                ...
                className="w-full h-full object-cover"
                onError={() =>
                  setImageUrl(getPlaceholderImage("farming,tutorial-error"))
                }
              />
        ...
        <div className="aspect-video bg-gray-100 dark:bg-gray-700 relative">
          {imageUrl ? (
            <img
              ...
              className="w-full h-full object-cover"
              onError={() =>
                setImageUrl(getPlaceholderImage("farming,agriculture-error"))
              }
            />
          ) : (
            <div className="absolute inset-0 flex items-center justify-center">
      ...
      <div className="p-6">
        <div className="flex justify-between items-center mb-3">
          <span className="text-xs font-medium bg-green-50 dark:bg-green-900/30 text-green-700 dark:text-green-400 px-3 py-1 rounded-full">
            {category}
          </span>
...
const PostCard = ({
  ...
  useEffect(() => {
    if (imagePath) {
      ...
      setImageUrl(
        getPlaceholderImage(`farming-${region.toLowerCase()}-${keywords}`)
      );
    }
        ...
        <div className="aspect-video bg-gray-100 dark:bg-gray-700 rounded-xl relative overflow-hidden">
          {imageUrl ? (
            <img
              ...
              className="w-full h-full object-cover"
              onError={() =>
                setImageUrl(getPlaceholderImage("farming-field-error"))
              }
            />
          ) : (
            <div className="absolute inset-0 flex items-center justify-center">
  ...
  const weatherForecast: WeatherDay[] = [
    {
      ...
      temp: 28,
      condition: "Sunny",
      icon: <MdOutlineWbSunny className="h-8 w-8 text-yellow-500" />,
    },
    {
      day: "Tomorrow",
      temp: 26,
          ...
          <div className="container mx-auto px-4 py-20 lg:py-24 relative z-10">
            <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
              ...
              >
                ...
                >
                  Smart <span className="text-green-300">Crop Selection</span>{" "}
                  for Better Harvest
                </motion.h1>
                <motion.p
                  initial={{ opacity: 0, y: 20 }}
                ...
                >
                  Use AI-powered recommendations to maximize your yield and
                  profit based on soil conditions, location, and climate data.
                </motion.p>
                <motion.div
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4 text-gray-900 dark:text-gray-100">
                How CropPredict Works
              </h2>
              <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
                Our AI-powered platform analyzes multiple factors to recommend
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              >
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  We analyze your soil type and quality to determine which crops
                  will thrive.
                </p>
              </motion.div>
              <motion.div
              ...
              >
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  We match crops to your region's climate patterns for optimal
                  growing conditions.
                </p>
              </motion.div>
              <motion.div
              ...
              >
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  We identify crops with highest profit potential based on
                  ...
                  <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700 overflow-hidden">
                    <div className="bg-gradient-to-r from-green-500 to-green-600 p-6">
                      ...
                      <p className="text-green-100 mt-2">
                        Fill in your farm details below for AI-powered
                        suggestions
                      </p>
                    </div>
                    <div className="p-6">
              ...
              <div className="w-full lg:w-7/12 order-1 lg:order-2">
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-md border border-gray-100 dark:border-gray-700 overflow-hidden mb-8">
                  <div className="p-6 border-b border-gray-100 dark:border-gray-700">
                    ...
                    <p className="text-gray-500 dark:text-gray-400 mt-2">
                      Here are some sample recommendations. Provide your details
                      to get personalized crop suggestions.
                    </p>
                  </div>
                  <div className="p-6">
                ...
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-md border border-gray-100 dark:border-gray-700 overflow-hidden">
                  <div className="p-6 border-b border-gray-100 dark:border-gray-700">
                    ...
                    <p className="text-gray-500 dark:text-gray-400 mt-2">
                      Weather conditions affect crop growth. Check the 5-day
                      forecast below.
                    </p>
                  </div>
                  <div className="p-6">
                    ...
                    <div className="flex justify-end mt-4">
                      <Link href="/learn">
                        <Button
                          variant="outline"
                          className="flex items-center gap-1 text-green-600 dark:text-green-400 h-9 rounded-md px-4 text-sm"
                        >
          ...
          <div className="container mx-auto px-4">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-10">
              <div>
                ...
                <p className="text-gray-500 dark:text-gray-400 mt-2">
                  Expand your farming knowledge with our expert resources
                </p>
              </div>
                ...
                <div className="aspect-video relative overflow-hidden">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent flex flex-col justify-end p-6">
                    ...
                    <p className="text-white/80 text-sm">
                      Learn farming techniques through step-by-step videos
                    </p>
                  </div>
                </div>
                <div className="p-6">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 text-sm mb-4">
                    Learn how technology is transforming traditional farming
                    practices for higher yields.
                  </p>
                  <Link
                    href="/learn/videos"
                    className="text-green-600 dark:text-green-400 text-sm font-medium flex items-center hover:underline"
                  >
              ...
              >
                <div className="aspect-video relative overflow-hidden">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent flex flex-col justify-end p-6">
                    ...
                    <p className="text-white/80 text-sm">
                      In-depth guides and research from agricultural specialists
                    </p>
                  </div>
                </div>
                <div className="p-6">
                  <div className="flex justify-between items-center mb-4">
                    <span className="text-xs font-medium bg-orange-100 dark:bg-orange-900/30 text-orange-700 dark:text-orange-400 px-3 py-1 rounded-full">
                      New
                    </span>
                    <span className="text-xs text-gray-500 dark:text-gray-400">
                      24 articles
                  ...
                  <p className="text-gray-600 dark:text-gray-400 text-sm mb-4">
                    Discover eco-friendly methods to improve soil health and
                    crop resilience.
                  </p>
                  <Link
                    href="/learn/articles"
                    className="text-orange-600 dark:text-orange-400 text-sm font-medium flex items-center hover:underline"
                  >
              ...
              >
                <div className="aspect-video relative overflow-hidden">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent flex flex-col justify-end p-6">
                    ...
                    <p className="text-white/80 text-sm">
                      Self-paced learning modules for farmers of all experience
                      levels
                    </p>
                  </div>
                </div>
                <div className="p-6">
                  <div className="flex justify-between items-center mb-4">
                    <span className="text-xs font-medium bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-400 px-3 py-1 rounded-full">
                      Popular
                    </span>
                    <span className="text-xs text-gray-500 dark:text-gray-400">
                      8 courses
                  ...
                  <p className="text-gray-600 dark:text-gray-400 text-sm mb-4">
                    Learn strategic planning for maximizing soil nutrients and
                    preventing pests.
                  </p>
                  <Link
                    href="/learn/courses"
              ...
              <div className="flex flex-col md:flex-row items-center justify-between gap-6">
                <div className="md:w-2/3">
                  ...
                  <p className="text-gray-700 dark:text-gray-300 mb-4">
                    ...
                    with Dr. Patel from the Agricultural Research Institute
                  </p>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center mb-12">
              ...
              <p className="text-gray-500 dark:text-gray-400">
                Join thousands of farmers who have transformed their agriculture
                practices with CropPredict
              </p>
            </div>
            <div className="grid md:grid-cols-3 gap-8">
                  ...
                  <div className="w-full h-0 pb-[56.25%] relative bg-gray-100 dark:bg-gray-700">
                    <div className="absolute inset-0 flex items-center justify-center">
                      <div className="text-center">
                        ...
                        <p className="text-gray-500 dark:text-gray-400">
                          Success stories from farmers across India
                        </p>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-lg opacity-90 mb-8">
                Get personalized crop recommendations based on your farm's
                unique conditions
              </p>
              <Button
                className="bg-white text-green-700 hover:bg-green-100 h-12 px-8 rounded-full shadow-lg font-semibold"
